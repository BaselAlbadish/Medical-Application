...
import 'package:mdcin_ca/features/profile/profile_view/presentation/widgets/cards/course/course_item.dart';
...
class CoursesMore extends StatelessWidget {
  CoursesMore({required this.list, Key? key}) : super(key: key);
  List<Course> list;
